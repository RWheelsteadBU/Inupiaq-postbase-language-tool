...
<!-- Also, make individual html blocks for each set of interactive text-->
...
```{=html}
<!-- This block allows the text and a hover pop up-->

<!-- This is for the text seen on the page -->
<div class="my-hover">
  Taiguaqta by Edna Ahgeak MacLean
  
  <!-- This is for the text in the pop up -->
  <div class="my-hover-text">
    <p><strong> Taiguaq-ta </strong></p>
  
    <p> Ending "ta" is for third-person plural. </p>
